...
#
# Generated on 2026-09-18T15:31:59Z by kres 3e1d3c0.
...
RUN --mount=type=cache,target=/root/.cache/go-build,id=go-pcidb/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=go-pcidb/go/pkg go install github.com/shanduur/dis-vulncheck@${DIS_VULNCHECK_VERSION} \
...
WORKDIR /src
RUN --mount=type=cache,target=/root/.cache/go-build,id=go-pcidb/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=go-pcidb/go/pkg dis-vulncheck -tool=false ./...
